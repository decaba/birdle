this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    var ga = function(e) {
        ...
        return o(t, [{
            ...
            value: function() {
                var e, a = this;
                this.shadowRoot.appendChild(ya.content.cloneNode(!0)), this.shadowRoot.querySelector("#hash").textContent = null === (e = window.wordle) || void 0 === e ? void 0 : e.hash, this.shadowRoot.querySelector("#puzzle-number").textContent = "Birdle #".concat(this.gameApp.dayOffset - 205), this.shadowRoot.addEventListener("game-switch-change", function(e) {
                    e.stopPropagation();
                    var s = e.detail,
                        t = s.name,
                        o = s.checked,
